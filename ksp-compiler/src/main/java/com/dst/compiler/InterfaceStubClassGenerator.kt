...
internal object InterfaceStubClassGenerator {
    ...
    private fun buildInvokeFunctionAndBody(
        ...
        writer.appendLine()
            .appendLine("\toverride fun invokeNonSuspendFunction(functionOwner: Class<*>, functionName: String, functionUniqueKey: String, functionParameterTypes: List<Class<*>>, functionParameterValue: List<Any?>): Any? {")
            .apply {
            ...
            .appendLine("\t}")
            .appendLine()
            .appendLine("\toverride suspend fun invokeSuspendFunction(functionOwner: Class<*>, functionName: String, functionUniqueKey: String, functionParameterTypes: List<Class<*>>, functionParameterValue: List<Any?>): Any? {")
            .apply {
    ...
    private fun buildPropertyInvocationCode(
        ...
        if (ksPropertyDeclaration.extensionReceiver != null) {
            ...
            stringBuilder.append("this.implementationInstance.run { (functionParameterValue[0]")
    ...
    private fun buildFunctionInvocationParameter(
        ...
        return StringBuilder().also { builder ->
            ksFunctionDeclaration.parameters.forEachIndexed { index, ksValueParameter ->
                ...
                builder.append("functionParameterValue[${index + parameterOffset}]")
